const interviewBtn7 = document.getElementById('interview-7');
interviewBtn7.addEventListener('click', function () {
  ...
  // badge
  document.getElementById('badge-interview-7').classList.remove('hidden')
  ...
  newInterview.innerHTML =`<div class="bg-[#FFFFFF] mt-3 pl-5 pb-5">
      <div class="flex justify-between">
        <h1 class="pt-5 font-bold text-[16px]">Mobile Seven Corp</h1>
