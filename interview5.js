const interviewBtn5 = document.getElementById('interview-5');
interviewBtn5.addEventListener('click', function () {
  ...
  // badge
  document.getElementById('badge-interview-5').classList.remove('hidden')
  ...
  newInterview.innerHTML =`<div class="bg-[#FFFFFF] mt-3 pl-5 pb-5">
      <div class="flex justify-between">
        <h1 class="pt-5 font-bold text-[16px]">Mobile Fifth Corp</h1>
