const rejectedBtn5 = document.getElementById('rejected-5');
rejectedBtn5.addEventListener('click', function () {
  ...
  document.getElementById('badge-rejected-5').classList.remove('hidden');
  ...
  newRejectedElements.innerHTML=` <div class="bg-[#FFFFFF] mt-3 pl-3 pb-5">
      <div class="flex justify-between">
        <h1 class="pt-5 font-bold text-[16px]">Mobile Fift Corp</h1>
