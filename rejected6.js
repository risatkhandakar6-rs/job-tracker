const rejectedBtn6 = document.getElementById('rejected-6');
rejectedBtn6.addEventListener('click', function () {
  ...
  document.getElementById('badge-rejected-6').classList.remove('hidden');
  ...
  newRejectedElements.innerHTML=` <div class="bg-[#FFFFFF] mt-3 pl-3 pb-5">
      <div class="flex justify-between">
        <h1 class="pt-5 font-bold text-[16px]">Mobile Sixth Corp</h1>
