const rejectedBtn7 = document.getElementById('rejected-7');
rejectedBtn7.addEventListener('click', function () {
  ...
  document.getElementById('badge-rejected-7').classList.remove('hidden');
  ...
  newRejectedElements.innerHTML=` <div class="bg-[#FFFFFF] mt-3 pl-3 pb-5">
      <div class="flex justify-between">
        <h1 class="pt-5 font-bold text-[16px]">Mobile Senen Corp</h1>
